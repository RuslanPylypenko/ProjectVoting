 ...
 */
final class Version20241106194202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, author_id INT NOT NULL, rejected_by_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, budget NUMERIC(10, 0) NOT NULL, category SMALLINT UNSIGNED NOT NULL, status SMALLINT UNSIGNED NOT NULL, rejected_reason VARCHAR(255) DEFAULT NULL, rejected_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, address_house_number VARCHAR(36) DEFAULT NULL, address_street VARCHAR(255) DEFAULT NULL, address_postal_code VARCHAR(16) DEFAULT NULL, address_city VARCHAR(255) NOT NULL, address_country VARCHAR(255) NOT NULL, INDEX IDX_5C93B3A4613FECDF (session_id), INDEX IDX_5C93B3A4F675F31B (author_id), INDEX IDX_5C93B3A4CBF05FC9 (rejected_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE refresh_tokens (id INT AUTO_INCREMENT NOT NULL, refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid DATETIME NOT NULL, UNIQUE INDEX UNIQ_9BACE7E1C74F2195 (refresh_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session_stages (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, name VARCHAR(32) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, INDEX IDX_40C9603D613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE session_stages ADD CONSTRAINT FK_40C9603D613FECDF FOREIGN KEY (session_id) REFERENCES sessions (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session_stages DROP FOREIGN KEY FK_40C9603D613FECDF');
