...
final class Version20241025170206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cities (
            ...
            address_house_number VARCHAR(36) DEFAULT NULL, 
        ...
        $this->addSql('CREATE TABLE project_votes (
            id INT AUTO_INCREMENT NOT NULL, 
            project_id INT NOT NULL, 
            user_id INT NOT NULL, 
            created_at DATETIME NOT NULL, 
            UNIQUE INDEX UNIQ_42DE7351166D1F9C (project_id), 
            UNIQUE INDEX UNIQ_42DE7351A76ED395 (user_id), 
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE projects (
            ...
            address_city VARCHAR(255) NOT NULL, 
            address_country VARCHAR(255) NOT NULL, 
            INDEX IDX_5C93B3A4613FECDF (session_id), 
            INDEX IDX_5C93B3A4F675F31B (author_id), 
            INDEX IDX_5C93B3A4CBF05FC9 (rejected_by_id), 
            PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE projects_categories (
            project_entity_id INT NOT NULL, 
            category_entity_id INT NOT NULL, 
            INDEX IDX_8C4CD7929019388A (project_entity_id), 
            INDEX IDX_8C4CD7924645AF6D (category_entity_id), 
            PRIMARY KEY(project_entity_id, category_entity_id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE session_stages (
            id INT AUTO_INCREMENT NOT NULL, 
        ...
        $this->addSql('CREATE TABLE sessions (
            ...
            winner_requirements_id INT NOT NULL, 
            submission_requirements_id INT NOT NULL, 
            voting_requirements_id INT NOT NULL, 
            name VARCHAR(255) NOT NULL, 
            INDEX IDX_9A609D138BAC62AF (city_id), 
            UNIQUE INDEX UNIQ_9A609D133D68F49B (winner_requirements_id), 
            UNIQUE INDEX UNIQ_9A609D13DDFF59AA (submission_requirements_id), 
            UNIQUE INDEX UNIQ_9A609D133FB81352 (voting_requirements_id), PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE submission_requirements (
            session_id INT NOT NULL, 
            min_age INT NOT NULL, 
            categories JSON DEFAULT NULL, 
            max_budget VARCHAR(255) NOT NULL, 
            min_budget VARCHAR(255) NOT NULL, 
            only_residents TINYINT(1) NOT NULL, 
            PRIMARY KEY(session_id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

        $this->addSql('CREATE TABLE voting_requirements (
            session_id INT NOT NULL, 
            min_age INT NOT NULL, 
        ...
        $this->addSql('CREATE TABLE winner_requirements (
            session_id INT NOT NULL, 
        ...
        $this->addSql('ALTER TABLE sessions ADD CONSTRAINT FK_9A609D133D68F49B FOREIGN KEY (winner_requirements_id) REFERENCES winner_requirements (session_id)');
        $this->addSql('ALTER TABLE sessions ADD CONSTRAINT FK_9A609D13DDFF59AA FOREIGN KEY (submission_requirements_id) REFERENCES submission_requirements (session_id)');
        $this->addSql('ALTER TABLE sessions ADD CONSTRAINT FK_9A609D133FB81352 FOREIGN KEY (voting_requirements_id) REFERENCES voting_requirements (session_id)');
        ...
        $this->addSql('ALTER TABLE users 
            ADD birth_date DATETIME NOT NULL, 
            ADD created_at DATETIME NOT NULL, 
            ADD updated_at DATETIME NOT NULL, 
            ADD living_address_house_number VARCHAR(36) DEFAULT NULL, 
            ADD living_address_street VARCHAR(255) DEFAULT NULL, 
            ADD living_address_postal_code VARCHAR(16) DEFAULT NULL, 
            ADD living_address_city VARCHAR(255) NOT NULL, 
            ADD living_address_country VARCHAR(255) NOT NULL, 
            ADD registration_address_house_number VARCHAR(36) DEFAULT NULL, 
            ADD registration_address_street VARCHAR(255) DEFAULT NULL, 
            ADD registration_address_postal_code VARCHAR(16) DEFAULT NULL, 
            ADD registration_address_city VARCHAR(255) NOT NULL, 
            ADD registration_address_country VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sessions DROP FOREIGN KEY FK_9A609D133D68F49B');
        $this->addSql('ALTER TABLE sessions DROP FOREIGN KEY FK_9A609D13DDFF59AA');
        $this->addSql('ALTER TABLE sessions DROP FOREIGN KEY FK_9A609D133FB81352');
        ...
        $this->addSql('ALTER TABLE users DROP birth_date, DROP created_at, DROP updated_at, DROP living_address_house_number, DROP living_address_street, DROP living_address_postal_code, DROP living_address_city, DROP living_address_country, DROP registration_address_house_number, DROP registration_address_street, DROP registration_address_postal_code, DROP registration_address_city, DROP registration_address_country');
    }
}
