 ...
 */
final class Version20241105180642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projects ADD category SMALLINT UNSIGNED NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_entity (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE projects_categories ADD CONSTRAINT FK_8C4CD7924645AF6D FOREIGN KEY (category_entity_id) REFERENCES category_entity (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE projects_categories ADD CONSTRAINT FK_8C4CD7929019388A FOREIGN KEY (project_entity_id) REFERENCES projects (id) ON UPDATE NO ACTION ON DELETE CASCADE');
